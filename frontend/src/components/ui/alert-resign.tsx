...
import { Button } from '@/components/ui/button.tsx'; // Assuming Button is available from this path
...
export default function ResignButton({ onResign }: { onResign: () => Promise<void> }) {
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Do you really want to resign?</AlertDialogTitle>
